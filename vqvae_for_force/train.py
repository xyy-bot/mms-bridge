...
from config import DATA_FOLDER, TRAIN_DATA_FOLDER, HAS_HEADER, DELIMITER, INPUT_SIZE, OUTPUT_SIZE, HIDDEN_SIZE, NUM_LAYERS, \
...
def main():
    ...
    for epoch in range(1, NUM_EPOCHS + 1):
        ...
        print(
            f"Epoch {epoch:02d} | Train Loss: {train_loss:.4f}| Test Acc: {train_accuracy * 100:.2f}%")
