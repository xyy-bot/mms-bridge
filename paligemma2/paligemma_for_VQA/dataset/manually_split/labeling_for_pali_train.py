...
# User configuration
# ---------------------------
dataset_dir = './train'  # Directory containing your subfolders (e.g., "empty_cola_can_0", "real_potato_1", etc.)
output_jsonl = 'annotation_for_paligemma_train.jsonl'  # Output JSONL file
