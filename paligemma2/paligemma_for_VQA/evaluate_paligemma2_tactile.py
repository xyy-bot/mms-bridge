...
checkpoint_path = "check_point/paligemma2_vqa_finetune_half_v3/checkpoint-1104"  # Replace XXXX with your checkpoint number
...
with open("inference_results_6epoch_half_divided.json", "w") as f:
